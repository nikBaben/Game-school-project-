...
class Score_panel():
    ...
    def draw_score(self):
        ...
        self.screen.blit(self.new_score_img,(470,0))# (((self.screen.get_rect().width)/2 )+self.new_score_img.get_rect().width -60, 525))#(450,480)) #(self.screen.get_rect().width - self.new_score_img.get_rect().width - 10, 30))
